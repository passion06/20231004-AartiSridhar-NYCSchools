...
class SchoolListActivityAdapter(
    private var schoolList: List<SchoolDataModel>,
    private val itemClickListener: ItemClickListener,
    private val context: Context
) : RecyclerView.Adapter<SchoolListActivityAdapter.SchoolViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SchoolViewHolder, position: Int) {
        ...
        //Making the link clickable for the website
        ...
        holder.itemView.setOnClickListener {
            if (schoolItem.dbn.isNotEmpty()) {
                ...
                //Handling case when dbn is empty
                itemClickListener.onError(context.getString(string.error_text))
            }
        }
    }

    inner class SchoolViewHolder(itemBinding: SchoolItemBinding) :
